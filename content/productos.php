...
<div id="products-panel" class="panel">
    ...
    <nav class="panel-grid products-nav-grid">
        ...
        <button class="btn" type="button" onclick="showSectioninventario('import')">Importar</button>
    ...
    <section id="import" class="hidden product-section">
        ...
        <div class="form-row form-actions">
            ...
            <button class="btn" type="button" onclick="downloadProductsTemplate('csv')">Plantilla CSV</button>
            <button class="btn" type="button" onclick="downloadProductsTemplate('json')">Plantilla JSON</button>
            <button class="btn" type="button" onclick="exportProductsFile('csv')">Respaldo CSV</button>
            <button class="btn" type="button" onclick="exportProductsFile('json')">Respaldo JSON</button>
        </div>
