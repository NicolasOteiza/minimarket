        ...
        <div class="content printer-shell">
            <form id="printer-settings-form">
                <div class="printer-card">
                    ...
                    <p class="printer-note">Si ejecutas <code>iniciar_impresion_local.bat</code> en el equipo cliente se listaran sus impresoras locales. Si no, se imprimira por navegador usando la impresora predeterminada de ese equipo.</p>
